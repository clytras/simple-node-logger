...
const AbstractAppender = function(options) {
    ...
    this.formatMessage = function(msg, thisArg) {
        ...
        if(typeof(appender.filterMessage) === 'function') {
            return appender.filterMessage(result);
        } else if(typeof(options.filterMessage) === 'function') {
            return options.filterMessage(result);
        }
